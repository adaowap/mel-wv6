public class ExercicioTemperatura    {
    public static void main(String[] args) {
        ...
        String[] cidade = {"Londres", "Madrid", "Nova York", "Buenos Aires", "Assunción", "São Paulo",
                "Lima", "Santiago de Chile", "Lisboa", "Tokio"};
        //Declaração e atribuição da Matriz com as temperaturas mínimas e máximas
        int[][] temperatura = {{-2, 33}, {-3, 32}, {-8, 27}, {4, 37},
                {6, 42}, {5, 43}, {0, 39}, {-7, 26}, {-1, 31}, {-10, 35}};
        ...
        System.out.println("Cidade com menor temperatura: " + cidadeMinima +
                " - Temperatura = " + temperaturaMinima);
        System.out.println("Cidade com maior temperatura: " + cidadeMaxima +
